...
export const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (user === "admin@admin" && password == "12345") {
      ...
      setError(
        `Senha incorreta para ${user} Você pode usar um código de acesso, redefinir sua senha ou tentar novamente.`
      );
    }
  };
    ...
    <div className={styles.background}>
      ...
      <div className={styles.login}>
        <div className={styles.entrar}>
          ...
          />
          <span className={styles.passerro}>{errorUser && errorUser}</span>
          ...
          />
          <span className={styles.passerro}>
          ...
          <p className={styles.assine}>
            Esta página é protegida pelo Google CAPTCHA para garantir que você
